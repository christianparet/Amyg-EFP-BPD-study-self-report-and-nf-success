####################################################################
# Code to analyze volume of auditory feedback received during training in study EFPTest
# Zopfs, Sicorello, Paret, ZI Mannheim, 2023
####################################################################
...
Volume.M <- lmer(mean_vol_neurofeedback ~
...
qqnorm(resid(Volume.M))
qqline(resid(Volume.M))
# is normally distributed

summary(Volume.M)
# Fixed effects:
#   Estimate Std. Error        df t value Pr(>|t|)    
# (Intercept)  0.542428   0.011825 14.954956  45.872   <2e-16 ***
#   session     -0.007866   0.003387 14.150275  -2.323   0.0356 *  
#   ---
#   Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

rsquared(Volume.M)
#   Response               family   link       method Marginal     Conditional
# 1 mean_vol_neurofeedback gaussian identity   none   0.03267322   0.2485293
